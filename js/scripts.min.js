...
$(function(){function e(){$(".carousel-services-item").each(function(){ths=$(this),thsh=ths.find(".carousel-services-content").outerHeight(),ths.find(".carousel-services-image").css("min-height",thsh)})}function s(){$(".carousel-services-content").equalHeights()}$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black","position-left","position-front"],navbar:{title:'<img src="img/ping-logo.svg">'},offCanvas:{position:"right"}}),$("#my-menu").data("mmenu").bind("close:finish",function(){$(".hamburger").removeClass("is-active")}).bind("open:finish",function(){$(".hamburger").addClass("is-active")}),$(".carousel-services").owlCarousel({loop:!0,nav:!0,smartSpeed:600,navText:['<i class="fas fa-angle-double-left"></i>','<i class="fas fa-angle-double-right"></i>'],responsiveClass:!0,dots:!1,responsive:{0:{items:1},700:{items:2},1200:{items:3}}}),$(".carousel-services").on("initialized.owl.carousel",function(){setTimeout(function(){e()},100)}),$(".carousel-services-content").equalHeights(),e(),$("select").selectize({openOnFocus:!1,onInitialize:function(){var e=this;this.$control.on("click",function(){e.ignoreFocusOpen=!0,setTimeout(function(){e.ignoreFocusOpen=!1},50)})},onFocus:function(){this.ignoreFocusOpen||this.open()}}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"/mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(".reviews").owlCarousel({loop:!0,items:1,smartSpeed:700}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),s(),window.onresize=function(){s()}}),$(window).on("load",function(){$(".preloader").delay(800).fadeOut("slow")});